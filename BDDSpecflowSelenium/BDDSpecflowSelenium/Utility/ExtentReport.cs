...
namespace BDDSpecflowSelenium.Utility
{
    public class ExtentReport
    {
        ...
        {
            ExtentSparkReporter htmlReporter = new ExtentSparkReporter(testResultPath);
            ...
            _extentReports.AddSystemInfo("Application", "RahulShetty");
